...
public enum Messages {
    ...
    CANCEL_BREEDING_ENABLED("<color:#59ffa4>連続餌やり無効化中!</color>"),
    CANCEL_BREEDING_DISABLED("<color:#ff4775>連続餌やり有効化中!</color>"),
    CONFIG_RELOAD("<color:#ff4775>configリロード完了!</color>"),
